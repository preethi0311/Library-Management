...
function Reignsethra() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      title: "Reign Sethra's",
      author: "Stephen Brist",
      isbn: "120",
      category: "Fantasy",
      almirah: "Reign Sethra's(Fantasy)",
      edition: "19th",
      ...
      image: "https://images-platform.99static.com//dwTNLDRxoGyLB_hKk8g8wQlc7Fo=/21x101:812x892/fit-in/500x500/projects-files/77/7779/777916/b786e2bd-feec-4b86-8fdd-0f745759efc3.jpg",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Reign Sethra's",   // optional: identify which book
      author: "Stephen Brist",
      isbn: "120",
      category: "Fantasy",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://images-platform.99static.com//dwTNLDRxoGyLB_hKk8g8wQlc7Fo=/21x101:812x892/fit-in/500x500/projects-files/77/7779/777916/b786e2bd-feec-4b86-8fdd-0f745759efc3.jpg" />
          <Card.Body>
            <Card.Title className='title1'>Reign Sethra's</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Stephen Brist</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong>  Reign Sethra's</strong></h3><br />
          <p><strong>Id No. </strong>19</p>
          <p><strong>ISBN:</strong> is 120 </p>
          <p><strong>By Stephen Brist</strong></p>
          ...
          <p><strong>Almirah:</strong> Reign Sethra's ( Fantasy)</p>
          <p> <strong>Editon: </strong>5th</p>
