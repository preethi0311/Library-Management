...
function Knightmare() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      isbn: "105",
      category: "Fantasy",
      almirah: "Knightmare (Fantasy)",
      edition: "4th",
      publisher: "Upkar's Publishers",
      status: "Available",
      description: "Knightmare Arcanist is a dark, adventurous taleabout a world filledwith beauty and wonder,but also darkness and deception.",
      image: "https://images-platform.99static.com//irtuJaycfqG80g-AXkxjyCGu7h8=/0x97:812x909/fit-in/500x500/projects-files/56/5652/565254/4cba847c-57b6-41f3-9352-8f3543783531.jpg",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Knightmare Arcanist",   // optional: identify which book
      author: "Shami Stovall",
      isbn: "105",
      category: "Fantasy",
      status: "Available",
      ...
      <div className='homedesign'>
        ...
        <form>
          <Card className='homec ms-5 ' style={{ width: '16rem' }}>
            ...
            <Card.Body>
              <Card.Title className='title1 '>The KnightMare</Card.Title>
              <Card.Text className='card1 name="bookcaption '>
                KnightMare Arcanist is a magic-wrapped adventure
              </Card.Text><div />
              <p className='card1'>By Shami Stovall</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> KnightMare Arcanist</strong> </h3><br />
          <p><strong>Id No. </strong>4</p>
          <p><strong>ISBN:</strong> is 105 </p>
          <p><strong>By Shami Stovall</strong></p>
          ...
          <p><strong>Almirah:</strong> The KnightMare ( Fantasy)</p>
          <p> <strong>Editon: </strong>4th</p>
          <p><strong>Publishers: </strong>Upkar's Publishers</p>
          <p><strong>Description: </strong> Knightmare Arcanist is a dark, adventurous tale</p>
          <p>about a world filledwith beauty and wonder,</p>
          <p>but also darkness and deception.</p>
