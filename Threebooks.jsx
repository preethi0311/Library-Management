...
function Threebooks() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      title: "Keeper of Hidden",
      author: "Madeline Martin",
      isbn: "107",
      category: "Fantasy",
      almirah: "Keeper of Hidden (Fantasy)",
      edition: "6th",
      publisher: "Upkar's Publishers",
      status: "Available",
      description: "This book tells of the background and fate of these antediluvial keeper and their fathers, the watchers, the sons of God or holy ones boundaries of creation ",
      image: "https://i0.wp.com/noveldelights.com/wp-content/uploads/2023/09/img_5322.jpg?fit=1440%2C1440&ssl=1",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          ...
          <Card.Body>
            <Card.Title className='title1'>Keeper of Hidden</Card.Title>
            <Card.Text className='card1'>
              A heartwarming story about Books and Best Friends
            </Card.Text><div />
            <p className='card1'>By Madeline Martin</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Keeper of Hidden </strong></h3><br />
          <p><strong>Id No. </strong>6</p>
          <p><strong>ISBN:</strong> is 107 </p>
          <p><strong>By Madeline Martin </strong></p>
          ...
          <p><strong>Almirah:</strong> Keeper of Hidden  ( Fantasy)</p>
          <p> <strong>Editon: </strong>6th</p>
          ...
          <p>antediluvial keeper and their fathers, the watchers, the sons of </p>
