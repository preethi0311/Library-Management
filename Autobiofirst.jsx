...
function Autobiofirst() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      image: "https://cdn.kobo.com/book-images/204d7c7b-5dc1-4fbb-8727-59e6b9b4bb34/166/300/False/autobiography-94.jpg",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Autobiography of Rajendra Prasad",
      author: "Rajendra Prasad",
      isbn: "113",
      category: "Autobiography",
      status: "Available",
      edition: "12th",
      publisher: "Upkar's Publishers",  // optional: identify which book
      description: "This book tells of the background and fate of these antediluvial giants and their fathers, the watchers, the sons of God or holy ones boundaries of creation ",
      image: "https://cdn.kobo.com/book-images/204d7c7b-5dc1-4fbb-8727-59e6b9b4bb34/166/300/False/autobiography-94.jpg",
      comment: comment
    };
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://cdn.kobo.com/book-images/204d7c7b-5dc1-4fbb-8727-59e6b9b4bb34/166/300/False/autobiography-94.jpg" />
          <Card.Body>
            <Card.Title className='title1'>Autobiography Rajendra Prasad</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Rajendra Prasad</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Rajendra Prasad</strong></h3><br />
          <p><strong>Id No. </strong>12</p>
          <p><strong>ISBN:</strong> is 113 </p>
          <p><strong>By Rajendra Prasad </strong></p>
          ...
          <p><strong>Almirah:</strong> Rajendra Prasad Autobiography( Autobiography)</p>
          <p> <strong>Editon: </strong>12th</p>
