...
function Giants() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      image: "https://i.etsystatic.com/28249836/r/il/8168a4/5213573245/il_fullxfull.5213573245_q5ck.jpg",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Giants",   // optional: identify which book
      author: "Doug Cushman",
      isbn: "106",
      category: "Fantasy",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          ...
          <Card.Body>
            <Card.Title className='title1'>Giants</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Doug Cushman</p>
        ...
        <div className='aibook'>
          ...
          <p><strong>Id No. </strong>5</p>
          <p><strong>ISBN:</strong> is 106 </p>
          <p><strong>By Doug Cushman </strong></p>
          ...
          <p><strong>Almirah:</strong> The Giants ( Fantasy)</p>
