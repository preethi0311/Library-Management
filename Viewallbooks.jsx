...
import { Link } from 'react-router-dom';  // We'll create this CSS file

function Viewallbooks() {
  const [books, setBooks] = useState([]);            //it can be stored user documents in start an empty array

  useEffect(() => {
    axios.get("http://localhost:8002/viewallbooks")      //used to axios api and can get user details in backend
      .then((res) => {
        setBooks(res.data.msg);    ///data coming from api  it stored res.data.msg and can set user state
      })
      .catch((err) => {
        console.error(err);                    // find error used to console.log
      });
  }, []);
    ...
    <div className="dashboard-container">
      ...
      <main className="main-content">
        ...
        <div className='booktable'>
          <div className="table-container">         {/*container used to style this part*/}
            <h2>Books List</h2>
