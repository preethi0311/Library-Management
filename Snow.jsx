...
function Snow() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxUXXESJU6ptkcrmLlonUe2JMwG-9r0xzT441jSe9kFKTOyroq4Xv4fOJjpJe-ifSHJvY&usqp=CAU",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Snow Child",   // optional: identify which book
      author: "Eowyn Ivey",
      isbn: "114",
      category: "Novel",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxUXXESJU6ptkcrmLlonUe2JMwG-9r0xzT441jSe9kFKTOyroq4Xv4fOJjpJe-ifSHJvY&usqp=CAU" />
          <Card.Body>
            <Card.Title className='title1'>Snow Child</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Eowyn Ivey</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Snow Child </strong></h3><br />
          <p><strong>Id No. </strong>13</p>
          <p><strong>ISBN:</strong> is 114</p>
          <p><strong>By Eowyn Ivey </strong></p>
          ...
          <p><strong>Almirah:</strong> Snow Child ( Novel)</p>
          <p> <strong>Editon: </strong>13th</p>
