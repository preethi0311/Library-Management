...
function Secondheaderbook() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      almirah: "Story of My Life (Autobiography)",
      edition: "7th",
      publisher: "River Publishers",
      status: "Available",
      description: "This Autobiography book tells of the background and fate of these.God or holy ones boundaries of creation",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxEXxQgo2e-znbny5JDZ3d2Jje1uSXkBXjCvBXCYolTjOrbp1oe24MTBnvZWvPtZPxjhk&usqp=CAU",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Story of My Life",   // optional: identify which book
      author: "Helen Heller",
      isbn: "108",
      category: "Autobiography",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          ...
          <Card.Body>
            <Card.Title className='title1'>Story of My Life</Card.Title>
            <Card.Text className='card1'>
              The theme is determination and perseverance
            </Card.Text><div />
            <p className='card1'>By Helen Heller</p>
            <IoStar /><IoStar /><IoStar /><IoStar /><IoStar /><IoStar /><div /><br />
            <Button variant="primary ms-5  fs-5" onClick={handleBuyNow} disabled={isBuyDisabled}>Buy Now</Button>
          </Card.Body>
        </Card>
        <div /><br />
        ...
        <div className='aibook'>
          ...
          <h3><strong>Story of My Life</strong></h3><br />
          <p><strong>Id No. </strong>7</p>
          <p><strong>ISBN:</strong> is 108 </p>
          <p><strong>By Helen Heller </strong></p>
          <p><strong>Status: </strong><button className={`rounded text-dark ${bookStatus === "Available" ? "bg-success" : "bg-danger"}`}>{bookStatus}</button></p>
          <p><strong>Almirah:</strong>Story of My Life  (Autobiography )</p>
          <p> <strong>Editon: </strong>7th</p>
          <p><strong>Publishers: </strong>River Publishers</p>
          <p><strong>Description: </strong> This Autobiography book tells of the background and fate of these</p>
          <p>antediluvial heller and their fathers, the watchers, the sons of </p>
...
export default Secondheaderbook