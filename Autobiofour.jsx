...
function Autobiofour() {
    ...
    function handleBuyNow() {
        ...
        const book = {
            ...
            almirah: "Citizen (Autobiography)",
            edition: "9th",
            publisher: "Upkar's Publishers",
            status: "Available",
            description: " My Life After the White House is the second volume of memoirs by former president of the United States Bill Clinton. It was published on 19 November 2024. It covers Clinton's post-presidential",
            image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVlTiq8Dx7Rt1sBUzMsFuMqqHbvjsWnBpcIw&s",
    ...
    function handleCommentSubmit(e) {
        ...
        const data = {
            bookTitle: "Citizen",   // optional: identify which book
            author: "Bill Clinton",
            isbn: "110",
            category: "Autobiography",
            status: "Available",
        ...
        <div>
            ...
            <div className='homedesign'>
                ...
                <Card className='homec ms-5 ' style={{ width: '16rem' }}>
                    <Card.Img variant="top" height="190" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVlTiq8Dx7Rt1sBUzMsFuMqqHbvjsWnBpcIw&s" />
                    <Card.Body>
                        <Card.Title className='title1'>The Citizen</Card.Title>
                        <Card.Text className='card1'>
                            My Life After the White House is the second volume of memoirs
                        </Card.Text><div />
                        <p className='card1'>By Bill Clinton</p>
                ...
                <div className='aibook'>
                    ...
                    <h3><strong>The Citizen </strong></h3><br />
                    <p><strong>Id No. </strong>9</p>
                    <p><strong>ISBN:</strong> is 110 </p>
                    <p><strong>By Bill Clinton </strong></p>
                    ...
                    <p><strong>Almirah:</strong> The Citizen ( Autobiography)</p>
                    <p> <strong>Editon: </strong>9th</p>
                    <p><strong>Publishers: </strong>Upkar's Publishers</p>
                    <p><strong>Description: </strong> My Life After the White House is the second volume of memoirs  </p>
                    <p>of the United States Bill Clinton. It was published on 19  by former president </p>
                    <p>November 2024. It covers Clinton's post-presidential</p>
