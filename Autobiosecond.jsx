...
function Autobiosecond() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      almirah: "Autobiography (Autobiography)",
      edition: "11th",
      ...
      image: "https://www.indicinspirations.com/cdn/shop/products/wings-of-fire-an-autobiography-of-abdul-kalam-books-908170.jpg?v=1627154447&width=565",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://www.indicinspirations.com/cdn/shop/products/wings-of-fire-an-autobiography-of-abdul-kalam-books-908170.jpg?v=1627154447&width=565" />
          <Card.Body>
            <Card.Title className='title1'>Wings of Fire</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Dr.APJ.Abdulkalam</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Wings of Fire </strong></h3><br />
          <p><strong>Id No. </strong>11</p>
          <p><strong>ISBN:</strong> is 112 </p>
          <p><strong>By Dr.APJ.Abdul Kalam </strong></p>
          ...
          <p><strong>Almirah:</strong>Wings of Fire ( Autobiography)</p>
          <p> <strong>Editon: </strong>11th</p>
