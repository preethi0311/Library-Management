...
function Strugglestory() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbKMXNzU5QnD9JNBZw5rmeH0VDcJT0VvgIOg&s",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Struggle Story",   // optional: identify which book
      author: "Ashok Kumar",
      isbn: "115",
      category: "Novel",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbKMXNzU5QnD9JNBZw5rmeH0VDcJT0VvgIOg&s" />
          <Card.Body>
            <Card.Title className='title1'>Struggle Story</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Ashok Kumar</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Sruggle Story </strong></h3><br />
          <p><strong>Id No. </strong>14</p>
          <p><strong>ISBN:</strong> is 115 </p>
          <p><strong>By  Ashok Kumar</strong></p>
          ...
          <p><strong>Almirah:</strong> Struggle Story ( Novel)</p>
          <p> <strong>Editon: </strong>14th</p>
