...
function Dragon() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEYKvMlU_fnIsdYHzZZthdH5SHbIHe-0PNRQ&",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Dragon",   // optional: identify which book
      author: "Jason Hamilton",
      isbn: "121",
      category: "Fantasy",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEYKvMlU_fnIsdYHzZZthdH5SHbIHe-0PNRQ&" />
          <Card.Body>
            <Card.Title className='title1'>Dragon</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Jason Hamilton</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Dragon </strong></h3><br />
          <p><strong>Id No. </strong>20</p>
          <p><strong>ISBN:</strong> is 121 </p>
          <p><strong>By Jason Hamilton </strong></p>
          ...
          <p><strong>Almirah:</strong> Dragon( Fantasy)</p>
          <p> <strong>Editon: </strong>20th</p>
