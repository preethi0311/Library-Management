...
function Brightworld() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      ...
      image: "https://tolstoytherapy.com/wp-content/uploads/2022/09/51QQRmnMwDL.jpeg",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "Bright World",   // optional: identify which book
      author: "Eowyn Ivey",
      isbn: "116",
      category: "Novel",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://tolstoytherapy.com/wp-content/uploads/2022/09/51QQRmnMwDL.jpeg" />
          <Card.Body>
            <Card.Title className='title1'>Bright World</Card.Title>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Bright World</strong></h3><br />
          ...
          <p><strong>Almirah:</strong> Bright World ( Novel)</p>
