...
function Firstbind() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      title: "The first Bind",
      author: "R.R.Virdi",
      isbn: "119",
      category: "Fantasy",
      almirah: "First Bind(Fantasy)",
      edition: "18th",
      ...
      image: "https://mpd-biblio-covers.imgix.net/9781250840707.jpg",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "The First Bind",   // optional: identify which book
      author: "R.R.Virdi",
      isbn: "119",
      category: "Fantasy",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://mpd-biblio-covers.imgix.net/9781250840707.jpg" />
          <Card.Body>
            <Card.Title className='title1'>The First Bind</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By R.R.Virdi</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> The First Bind</strong></h3><br />
          <p><strong>Id No. </strong>18</p>
          <p><strong>ISBN:</strong> is 119 </p>
          <p><strong>By R.R.Virdi </strong></p>
          ...
          <p><strong>Almirah:</strong> The First Binding ( Fantasy)</p>
          <p> <strong>Editon: </strong>18th</p>
