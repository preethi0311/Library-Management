...
function Oneday() {
  ...
  function handleBuyNow() {
    ...
    const book = {
      title: "One Dy Change",
      author: "Saranya Umakanth",
      isbn: "117",
      category: "Fantasy",
      almirah: "One Dy Change(Novel)",
      edition: "16th",
      ...
      image: "https://www.clankart.com/user-uploads/advert/Fiction_Books_for_sale1721206589266.jpg",
  ...
  function handleCommentSubmit(e) {
    ...
    const data = {
      bookTitle: "One Day Change",   // optional: identify which book
      author: "Saranya Umakanth",
      isbn: "117",
      category: "Fantasy",
      status: "Available",
    ...
    <div>
      ...
      <div className='homedesign'>
        ...
        <Card className='homec ms-5 ' style={{ width: '16rem' }}>
          <Card.Img variant="top" height="190" src="https://www.clankart.com/user-uploads/advert/Fiction_Books_for_sale1721206589266.jpg" />
          <Card.Body>
            <Card.Title className='title1'>One Day Change</Card.Title>
            <Card.Text className='card1'>
              Large Beautifully illustrated hardcover childrens
            </Card.Text><div />
            <p className='card1'>By Sranya umakanth</p>
        ...
        <div className='aibook'>
          ...
          <h3><strong> Giants </strong></h3><br />
          <p><strong>Id No. </strong>15</p>
          <p><strong>ISBN:</strong> is 117 </p>
          <p><strong>By Sranya Umakanth </strong></p>
          ...
          <p><strong>Almirah:</strong> One Day Change(Novel)</p>
          <p> <strong>Editon: </strong>15th</p>
